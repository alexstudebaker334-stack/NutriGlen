    ...
    <section id="benefits" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <span className="inline-block font-semibold text-sm uppercase tracking-widest mb-3" style={{ color: "#003087" }}>
            Why NutriGlen
          </span>
            ...
            return (
              ...
              >
                <div
                  ...
                  style={
                    isNavy
                      ? { background: "#EBF4FF", color: "#003087" }
                      : { background: "#FFF4E8", color: "#E07820" }
                  }
                >
                  {b.icon}
                </div>
        ...
        {/* Stats row */}
        <div
          className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-8 rounded-3xl p-8"
        ...
        >
          {[
            ...
            <div key={s.label} className="text-center">
              <div className="text-3xl sm:text-4xl font-extrabold mb-1" style={{ color: "#E07820" }}>
                {s.num}
              </div>
